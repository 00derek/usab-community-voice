...
- **Option D — Allow free walkover in consolation draws, apply retirement penalty only in main draw**: Differentiate the rule by draw stage. Main draw matches — which directly affect seeding, qualification, and competitive standing — warrant a commitment requirement. Consolation rounds serve a development and sportsmanship purpose; forcing unwilling players to compete there produces no meaningful benefit and demonstrably leads to passive play. Permitting walkovers in cons without penalty removes the perverse incentive while preserving the rule's intent where it actually matters.
